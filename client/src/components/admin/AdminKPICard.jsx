...
const colorMap = {
  ...
  violet: { bg: 'bg-violet-500/10', border: 'border-violet-500/20', text: 'text-violet-400', glow: 'shadow-violet-500/10', chart: '#8b5cf6' },
  indigo: { bg: 'bg-indigo-500/10', border: 'border-indigo-500/20', text: 'text-indigo-400', glow: 'shadow-indigo-500/10', chart: '#6366f1' },
...
export default function AdminKPICard({ label, value, icon: Icon, color = 'blue', prefix = '', suffix = '', trend, loading, delay = 0, decimals = 0 }) {
